...
export function SuspendDeleteUsersScreen({ role }: { role: UserRole }) {
    ...
    <section className="card p-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="page-header">
          <h1 className="page-title">Suspend/Delete {roleLabelPlural}</h1>
          <p className="page-subtitle">
            Manage {roleLabel.toLowerCase()} lifecycle by suspending, reactivating, or deleting accounts.
          </p>
        </div>
        <button
          type="button"
          ...
          data-tooltip-id="suspend-delete-actions"
      ...
      <Tooltip id="suspend-delete-actions" place="bottom" style={{ zIndex: 50, fontSize: "0.75rem" }} />
    </section>
  );
}